...
import com.hmy.euclidean.entity.request.LoginRequestBody;
import com.hmy.euclidean.service.LoginService;
...
public class LoginController {
    ...
    public void login(@RequestBody LoginRequestBody requestBody, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (!firstName.isEmpty()) {
            ...
            LoginRequestBody loginRequestBody = new LoginRequestBody(requestBody.getUserId(), firstName);
